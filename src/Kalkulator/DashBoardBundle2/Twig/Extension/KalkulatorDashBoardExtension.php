...
namespace Kalkulator\DashBoardBundle\Twig\Extension;

use Symfony\Component\DependencyInjection\Definition;
use Symfony\Component\HttpFoundation\Request;
use Doctrine\Bundle\DoctrineBundle\Registry as Doctrine;

class KalkulatorDashBoardExtension extends \Twig_Extension{
	...
	*/
    ...
    public function menu() {
	   ...
	   'Dni' => array(
        ...
        return $this->environment->render('KalkulatorDashBoardBundle:Template:menu.html.twig', array(
            'menu' => $menu
        ));
    }
	...
	public function suma_dzien() {
		...
		$suma = $DzienRepository->getSumaDzien($data_wybrana);
        	...
        	return $this->environment->render('KalkulatorDashBoardBundle:Template:suma_dzien.html.twig', array(
            		'dni' => $dni,
